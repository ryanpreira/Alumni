...
<template>
    ...
    <div class="header">
        <div class="retorno">
        <p style="margin-left: 30px; color: white;" class="retornoHead">Eventos</p>
        </div>
    ...
    export default {
        ...
        methods: {
          ...
          this.imagem = event.target.files[0]; // Capturar o arquivo da imagem
          ...
          async enviarEvento() {
            ...
            console.log('Token:', token); // Adicione isso para verificar o token
